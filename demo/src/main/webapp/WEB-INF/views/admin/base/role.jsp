<html>
  <head>
	...
	<script type="text/javascript" src="./../resources/scripts/ux/ST.ux.TreeCheckNodeUI.js"></script>
	...
	<script type="text/javascript" src="./../resources/scripts/admin/base/ST.Base.Role.js"></script>
